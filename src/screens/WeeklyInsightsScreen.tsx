    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TrendingUp size={24} color={_C.sage} />
          </View>
          <Text
            style={{
              fontSize: 24,
        ...
        {insight && !loading && (
          <>
            <InsightSection
              icon={<BarChart3 size={16} color={_C.sage} />}
              title="Your Week"
            ...
            >
              ...
              <Pressable onPress={handleSaveToJournal}>
                ...
                >
                  <Bookmark
                    size={16}
                    color={savedToJournal ? _C.sage : "white"}
                    fill={savedToJournal ? _C.sage : "transparent"}
                  />
                  <Text
                    style={{
                      color: savedToJournal ? _C.sage : "white",
              ...
              <Pressable onPress={generateInsights}>
                ...
                >
                  <RefreshCw size={15} color={_C.sage} />
                  <Text
                    style={{
                      color: _C.sage,
                      fontSize: 14,
