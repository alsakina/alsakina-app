...
export default function JournalEntryScreen({
  ...
  if (loading) {
    return (
      ...
      >
        <ActivityIndicator size="large" color={_C.sage} />
      </SafeAreaView>
    );
  }
            ...
            {MOODS.map((m) => (
              <Pressable
                ...
                style={{
                  ...
                  borderRadius: 20,
                  backgroundColor:
                    mood === m ? _C.borderStrong : "white",
                  borderWidth: 1,
                  borderColor:
                    mood === m ? _C.sage : "rgba(135,169,107,0.1)",
                }}
              >
                <Text
                  style={{
                    fontSize: 13,
                    color: mood === m ? _C.sage : _C.textMuted,
          ...
          {!activePrompt &&
            ...
            (prompts.length > 0 || loadingPrompts) && (
              <View style={{ marginBottom: 16 }}>
                ...
                >
                  <Sparkles size={14} color={_C.sage} />
                  <Text
                    style={{
                      fontSize: 12,
                      fontWeight: "700",
